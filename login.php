...
$check_user = "select * from sspl_table where user_ic='$ic' AND user_pass='$pass'";                  //For Checking Identity Card exists or not
...
setcookie('id',$ic);
echo "<script>window.open('requisition.php','_self')</script>";}
